...
namespace RobotMap
{
    ...
    namespace Launcher
    {
        ...
        constexpr int kDeflectorRelayID = 0;
...
namespace FieldConstants
{
    ...
    constexpr frc::Translation3d kBluePassPose{1.5_m, kBlueHubPose.Y(), 0_m};
    constexpr frc::Translation3d kRedPassPose{15_m, kBlueHubPose.Y(), 0_m};
}
