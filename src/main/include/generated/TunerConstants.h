...
class TunerConstants {
    ...
    static constexpr configs::Slot0Configs steerGains = configs::Slot0Configs{}
        .WithKP(150).WithKI(0).WithKD(0.75)
...
private:
    ...
    static constexpr units::inch_t kFrontLeftXPos = 20_in / 2;
    static constexpr units::inch_t kFrontLeftYPos = 20_in / 2;
    ...
    static constexpr units::inch_t kFrontRightXPos = 20_in / 2;
    static constexpr units::inch_t kFrontRightYPos = -20_in / 2;
    ...
    static constexpr units::inch_t kBackLeftXPos = -20_in / 2;
    static constexpr units::inch_t kBackLeftYPos = 20_in / 2;
    ...
    static constexpr units::inch_t kBackRightXPos = -20_in / 2;
    static constexpr units::inch_t kBackRightYPos = -20_in / 2;
