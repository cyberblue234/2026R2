...
public:
    ...
    static constexpr swerve::SteerFeedbackType kSteerFeedbackType = swerve::SteerFeedbackType::RemoteCANcoder;
    ...
    static constexpr units::scalar_t kDriveGearRatio = 5.89;
    static constexpr units::scalar_t kSteerGearRatio = 12.1;
    static constexpr units::meter_t kWheelRadius = 2_in;
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = -0.20703125_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = RobotConstants::kWheelBase / 2;
    static constexpr units::inch_t kFrontLeftYPos = RobotConstants::kTrackWidth / 2;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = 0.5869140625_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = RobotConstants::kWheelBase / 2;
    static constexpr units::inch_t kFrontRightYPos = -RobotConstants::kTrackWidth / 2;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = -0.7668457_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -RobotConstants::kWheelBase / 2;
    static constexpr units::inch_t kBackLeftYPos = RobotConstants::kTrackWidth / 2;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = 0.071777734375_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -RobotConstants::kWheelBase / 2;
    static constexpr units::inch_t kBackRightYPos = -RobotConstants::kTrackWidth / 2;
